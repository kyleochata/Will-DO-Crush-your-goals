            ...
            <form onSubmit={handleSubmit} className={style.addTaskForm}>
              <div className={style.formInputs}>
                <label className={style.addTaskModalTxt}>
                  Title:
                  <div className={style.goalDesc}>
                    A broad overview of your goal. "Learn to develop web
                    applications"
                  </div>
                  <input
                ...
                <label className={style.addTaskModalTxt}>
                  Description:
                  <div className={style.goalDesc}>
                    Be specific with your goal. "Become a full stack developer
                    specializing in JS"{' '}
                  </div>
                  <textarea
                ...
                <label className={style.addTaskModalTxt}>
                  Why:
                  <div className={style.goalDesc}>
                    Make it relevant. "Becoming a full-stack web developer
                    aligns with my career aspirations and will open up job
                    opportunities in a field that I'm passionate about."{' '}
                  </div>
                  <textarea
                ...
                <label className={style.addTaskModalTxt}>
                  Measurables
                  <div className={style.goalDesc}>
                    Give quantifiable examples of how you will know your goal is
                    completed. "Complete a full stack web bootcamp, build a
                    portfolio, contribute to at least 3 open source Githubs,
                    build at least 5 MERN applications"{' '}
                  </div>
                  <textarea
                ...
                <label className={style.addTaskModalTxt}>
                  Due Date:
                  <div className={style.goalDesc}>
                    Making your goals time-bound provides a sense of urgency and
                    a clear deadline, motivating you to take action and track
                    your progress{' '}
                  </div>
                  <input
                    type="date"
