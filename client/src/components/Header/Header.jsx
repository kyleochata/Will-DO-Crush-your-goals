...
export default () => {
    ...
    const shouldDisplayBurgerMenu = window.innerWidth <= 800 && isAuthenticated;
        ...
        <div className="header">
            <div className="navItems">
                ...
                <div className="mobileMenu" style={{ display: showMenu ? 'flex' : 'none' }}>
                    ...
                    <Link className={`mobileMenuItem ${location.pathname === '/goals' ? 'active' : ''}`}  to='/goals' onClick={() => setShowMenu(false)}>Goals</Link>
                    <Link className={`mobileMenuItem ${location.pathname === '/tasks' ? 'active' : ''}`}  to='/tasks' onClick={() => setShowMenu(false)}>Tasks</Link>
                    <Link className={`mobileMenuItem ${location.pathname === '/calendar' ? 'active' : ''}`}  to='/calendar' onClick={() => setShowMenu(false)}>Calendar</Link>
                    <Link className={`mobileMenuItem ${location.pathname === '/report' ? 'active' : ''}`}  to='/report' onClick={() => setShowMenu(false)}>Reports</Link>
